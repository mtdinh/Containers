...
func (c *Client) NewContainer(ctx context.Context, id string, cType string, opts ...NewContainerOpts) (Container, error) {
...
func (c *Client) Restore(ctx context.Context, id string, cType string, checkpoint Image, opts ...RestoreOpts) (Container, error) {
	...
	ctr, err := c.NewContainer(ctx, id, cType, copts...)
	if err != nil {
		return nil, err
	}
